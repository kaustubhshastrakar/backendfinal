...
public class SkillsRestController 
{
    ...
    public SkillsRestController(SkillsService skillsService) {
        this.skillsService = skillsService;  // Inject SkillsService through constructor
    }
...
//	
	...
	@DeleteMapping("/deleteAssociate/{associateId}")
	public ResponseEntity<Void> deleteAssociateById(@PathVariable int associateId) {
	    try {
	        skillsService.deleteAssociateById(associateId);
